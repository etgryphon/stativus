...
Statechart = {
  ...
  version: '0.1',
	...
	create: function(config){
		...
		// config all the interal information 
		sc._all_states = {};
	  ...
	  /**
	    @private
	  */
	  sc._cascadeEvents = function(evt, args, responder, allStates, tree){
	  ...
	  sc._flushPendingEvents = function(){
	  ...
	  sc._cascadeEnterSubstates = function(start, requiredStates, index, tree, allStates){
	  ...
	  sc._fullExitFromSubstates = function(tree, stopState){
	  ...
	  sc._parentStates = function(state){
	    var ret = [], curr = state;
	  ...
	  sc._parentStatesWithRoot = function(state){
